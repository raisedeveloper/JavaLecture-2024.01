...
public class Ex02_Primitive {
		...
		public static void main(String[] args) {
			...
			/* 
			 * 실수 계열
			 * 		1. float:	4 바이트, 유효자리 - 소수점 이하 7자리 정도
			 * 		2. double:	8 바이트, 유효자리 - 소수점 이하 15자리 정도
			 * 주의 사항
			 * 		- 숫자값(예: 3.14, 2.728(자연 로그))은 기본적으로 double 타입임
			 * 		- float 타입의 숫자값 뒤에는 F를 붙여야 함(예: 3.14F) 유효숫자 갯수 중요
			 */
